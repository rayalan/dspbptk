...
RECIPE_MAP = {
    ...
    Recipe.ParticleContainer: RecipeDetails({ dsi.ElectromagneticTurbine : 2, dsi.CopperIngot : 2, dsi.Graphene: 2}, { dsi.ParticleContainer: 1 }, 4),
    Recipe.ParticleContainerAdvanced: RecipeDetails({ dsi.UnipolarMagnet : 10, dsi.CopperIngot : 2}, { dsi.ParticleContainer: 1 }, 4),
    ...
    Recipe.InformationMatrix : RecipeDetails({ dsi.Processor: 2, dsi.ParticleBroadband : 1}, {dsi.InformationMatrix: 1}, 10),
    ...
    Recipe.HighPuritySilicon: RecipeDetails({ dsi.SiliconOre : 2}, { dsi.HighPuritySilicon: 1,}, 2),
    Recipe.TitaniumIngot: RecipeDetails({ dsi.TitaniumOre : 2}, { dsi.TitaniumIngot: 1,}, 2),
    ...
    Recipe.Diamond : RecipeDetails({ dsi.EnergeticGraphite : 2}, { dsi.Diamond: 1,}, 2),
